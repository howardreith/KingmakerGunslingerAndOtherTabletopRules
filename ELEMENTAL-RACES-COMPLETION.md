...
**Owner-authorized 0.0.120 release preparation; partial completion. Nereid is
selectable (twenty traits total). Treacherous remains hidden after automatic
approval review rejected publication without native Player/save qualification.
The owner waived the final repetitive test matrix and authorized commit, merge,
push and release. Delivery hashes/status are recorded below when verified.**
...
- Active checkout: `KingmakerGunslinger-elemental-completion-120`, branch
  `codex/elemental-races-completion-120`, based on the released source plus its
  verification-record follow-up `dd0a344226c31e34d251702f5832e75525137260`.
  Origin/master remains `8e5eeae7973c71ca4b78dc8216d00d815af7ea26`.
  Version 120 was unused when checked. Original and private119 checkouts remain
  intact; no branch merge or history rewrite occurred.
...
| Treacherous Earth | Native terrain, daily action/resource, saved areas, 3D ground targeting and source-floor isolation implemented; 68 focused assertions passed | No | Native Player creation/respec and full trait/save integration remain unqualified; publication rejected by automatic review |
...
trait remains unpublished while these changes and complete integration qualify.
...
legacy-save integration. Neither rejected edit executed. Treacherous remains
unpublished; no allowlist or other approval policy was changed.
