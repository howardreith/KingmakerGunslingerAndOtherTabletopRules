...
Kingmaker Gunslinger `0.0.102` targets:
...
```powershell
gh release download v0.0.102 `
  --repo howardreith/KingmakerGunslingerAndOtherTabletopRules `
  --pattern 'KingmakerGunslinger-0.0.102-starter-bokken-combat-log-acadamae-toggle.zip' `
  --dir "$env:USERPROFILE\Downloads\KingmakerGunslinger-0.0.102"
```
