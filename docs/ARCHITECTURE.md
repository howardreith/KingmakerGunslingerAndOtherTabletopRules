...
The blueprint ledger contains 137 stable IDs: 136 active and one reserved, for one-hundred-thirty-six active blueprints. Sprint 105 adds the Death's Shot feature, ability, marker, death carrier, and True Grit choice. Earlier stable identities remain append-only. The standalone package continues to contain exactly one project-owned binary and no private reference assembly.
