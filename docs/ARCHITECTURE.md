...
Seeking checkpoint the ledger contains 243 stable IDs: 233 active and 10 reserved;
...
the current two-hundred-thirty-three active blueprints transaction without
