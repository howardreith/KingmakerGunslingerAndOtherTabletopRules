...
Expanded Summoning freezes the append-only foundation at 1371 stable IDs: 1370 active and one reserved. All 1116 feature identities register in every module state while
