...
Expanded Summoning freezes the append-only foundation at 1373 stable IDs: 1372 active and one reserved. All 1118 feature identities register in every module state while
