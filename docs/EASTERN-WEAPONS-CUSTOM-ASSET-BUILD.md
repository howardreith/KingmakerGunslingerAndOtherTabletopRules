...
2. Stage the 12 FBXs and dedicated builder into the authorized project:
...
4. Verify `Builds/Windows/kingmakergunslinger.easternweapons` is 310,375
   bytes with SHA-256
...
12 uniquely named prefabs, uses opaque Standard materials, removes cameras
...
At runtime, all 12 prefabs load into a candidate dictionary and must pass
