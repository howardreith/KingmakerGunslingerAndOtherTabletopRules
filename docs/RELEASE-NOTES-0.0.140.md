# Kingmaker Gunslinger 0.0.140

Release: `0.0.140-favored-class-integration`
Package: `KingmakerGunslinger-0.0.140-favored-class-integration.zip`
Build label: Kingmaker Gunslinger 0.0.140.
Publication status: owner authorized. Published under explicit owner
authorization on 2026-09-26, together with the Expanded Summoning Phase 1
release (0.0.140) it was merged with. The integration's in-game gate ran on
the pre-merge candidate `1088abb3d`; the merged 0.0.140 build passed repository
validation, the domain suite and a clean build. The qualification record is
...
**COMPLETE LOCALLY — AWAITING OWNER REVIEW** (PR #24). All 30
...
Fixes to existing Gunslinger behavior in this release (the owner decided
...
level-up through the Favored Class mod's normal flow; this release never
