...
foreach ($required in @('wakizashi.fbx', 'katana.fbx', 'nodachi.fbx',
...
foreach ($name in @('wakizashi.fbx', 'katana.fbx', 'nodachi.fbx')) {
...
Write-Host 'Prepared three original Eastern Weapon FBXs and the dedicated Unity builder.'
