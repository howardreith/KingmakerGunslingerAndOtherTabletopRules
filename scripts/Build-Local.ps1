...
if ($info.Version -ne '0.0.37') { throw "Build-Local supports only active version 0.0.37, observed $($info.Version)." }
...
$localRoot = Join-Path $root 'artifacts\local-runtime\0.0.37'
