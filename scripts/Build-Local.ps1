...
if ($info.Version -ne '0.0.67') { throw "Build-Local supports only active version 0.0.67, observed $($info.Version)." }
...
$localRoot = Join-Path $root 'artifacts\local-runtime\0.0.67'
...
& powershell.exe -NoProfile -ExecutionPolicy Bypass -File `
    (Join-Path $PSScriptRoot 'Test-DodgeHarmonyPatchCompatibility.ps1') `
