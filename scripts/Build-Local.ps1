...
if ($info.Version -ne '0.0.42') { throw "Build-Local supports only active version 0.0.42, observed $($info.Version)." }
...
$localRoot = Join-Path $root 'artifacts\local-runtime\0.0.42'
