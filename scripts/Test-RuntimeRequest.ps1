...
$request = New-KmgRuntimeRequest -Scenario 'mod-load-smoke' -ExpectedVersion '0.0.85' `
...
$presentationRequest = New-KmgRuntimeRequest `
    -Scenario 'observe-gunslinger-presentation' -ExpectedVersion '0.0.85' `
    -TimeoutSeconds 30 -ExitAfterCompletion $true -EvidenceDirectory $synthetic
...
$vendorRequest = New-KmgRuntimeRequest `
    -Scenario 'observe-vendor-table-contracts' -ExpectedVersion '0.0.85' `
    -TimeoutSeconds 30 -ExitAfterCompletion $true -EvidenceDirectory $synthetic
...
$fallbackRequest = New-KmgRuntimeRequest `
    -Scenario 'observe-production-firearm-fallbacks' -ExpectedVersion '0.0.85' `
    -TimeoutSeconds 30 -ExitAfterCompletion $true -EvidenceDirectory $synthetic
...
$lifecycleRequest = New-KmgRuntimeRequest `
    -Scenario 'observe-firearm-item-lifecycle-contracts' -ExpectedVersion '0.0.85' `
    -TimeoutSeconds 30 -ExitAfterCompletion $true -EvidenceDirectory $synthetic
...
Assert-Throws { New-KmgRuntimeRequest -Scenario 'unknown' -ExpectedVersion '0.0.85' `
...
Assert-Throws { New-KmgRuntimeRequest -Scenario 'mod-load-smoke' -ExpectedVersion '0.0.85' `
...
Assert-Throws { New-KmgRuntimeRequest -Scenario 'working-save-smoke' -ExpectedVersion '0.0.85' `
    -TimeoutSeconds 30 -ExitAfterCompletion $false -EvidenceDirectory $synthetic `
...
$featureRequest = New-KmgRuntimeRequest -Scenario 'generic-firearm-actions' `
    -ExpectedVersion '0.0.85' -TimeoutSeconds 30 -ExitAfterCompletion $true `
...
Assert-Throws { New-KmgRuntimeRequest -Scenario 'generic-firearm-actions' `
    -ExpectedVersion '0.0.85' -TimeoutSeconds 30 -ExitAfterCompletion $false `
