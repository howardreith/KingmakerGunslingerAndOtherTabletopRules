#!/usr/bin/env python3
"""Validate the strict standalone 0.0.24.1 Sprint 24 repair UMM ZIP."""
...
def main() -> int:
    ...
    with zipfile.ZipFile(args.archive) as archive:
        ...
        if info_json.get("Version") != "0.0.24.1":
            raise RuntimeError("Info.json does not declare version 0.0.24.1.")
    ...
    print("Sprint 24 repair standalone UMM package validation passed.")
