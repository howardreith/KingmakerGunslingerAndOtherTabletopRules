...
SPECIAL_NOTES = {
    ...
    "giant-spider": "Vermin chassis with bite and native poison; native 60-foot blindsight for tremorsense; bounded 50-foot Web resolved as a ranged touch attack with no save (a foe up to one size larger, the native web-grappled state, a Constitution-based break-free, two uses per summoning) with its own brain; immune to webs (Sprint 6; corrected 2026-09-25).",
    ...
    "giant-flytrap": "Huge plant chassis with four bites; bite grab on the shared summon grapple lifecycle with one link per bite, four at most; engulf of a Medium or smaller foe held since the round began; acid resistance 20; tremorsense as native blindsight (Sprint 4; corrected 2026-09-25).",
