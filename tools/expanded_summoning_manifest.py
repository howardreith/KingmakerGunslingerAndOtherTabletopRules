...
SPECIAL_NOTES = {
    ...
    "giant-flytrap": "Huge plant chassis with four bites; bite grab on the shared summon grapple lifecycle with one link per bite, four at most, durable across a save and a reload, and a mouth that holds or has engulfed a foe attacks no one else; engulf of a Medium or smaller foe held since the round began for 1d8+7 crushing and 2d6 acid each round; acid resistance 20; tremorsense as native blindsight (Sprint 4; corrected 2026-09-25 and 2026-09-26).",
