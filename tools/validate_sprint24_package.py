#!/usr/bin/env python3
"""Validate the strict standalone 0.0.24 Sprint 24 UMM ZIP."""
...
def main() -> int:
    ...
    with zipfile.ZipFile(args.archive) as archive:
        ...
        if info_json.get("Version") != "0.0.24":
            raise RuntimeError("Info.json does not declare version 0.0.24.")
    ...
    print("Sprint 24 standalone UMM package validation passed.")
