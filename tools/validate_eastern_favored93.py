...
def validate(root: Path) -> None:
    ...
    if VERSION in {"0.0.114", "0.0.115", "0.0.116", "0.0.117", "0.0.118", "0.0.119", "0.0.120", "0.0.121", "0.0.122", "0.0.123", "0.0.124", "0.0.125", "0.0.126", "0.0.127", "0.0.128", "0.0.129", "0.0.130", "0.0.131", "0.0.132", "0.0.133", "0.0.134", "0.0.136", "0.0.137", "0.0.138", "0.0.139"}:
        release_key = ("favoredClassIntegration139" if VERSION == "0.0.139" else "betterVendorsProgression138" if VERSION == "0.0.138" else "rapidReloadCombatFeat137" if VERSION == "0.0.137" else "rapidReloadProficiencyGate" if VERSION == "0.0.136" else "magicCircle134" if VERSION == "0.0.134" else "wordOfRecallFavoredClass133" if VERSION == "0.0.133" else "iconOverhaul132" if VERSION == "0.0.132"
