...
def validate(root: Path) -> None:
    ...
    if VERSION in {"0.0.114", "0.0.115", "0.0.116", "0.0.117", "0.0.118", "0.0.119", "0.0.120", "0.0.121", "0.0.122", "0.0.123", "0.0.124", "0.0.125", "0.0.126"}:
        release_key = ("wordOfRecallOracle126" if VERSION == "0.0.126"
