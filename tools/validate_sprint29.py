...
def validate(
    ...
    registration_token = (("ExpectedRegisteredBlueprintCount = 341 +"
        ...
        else "ExpectedRegisteredBlueprintCount = 329 +"
        ...
        else f"ExpectedRegisteredBlueprintCount = {expected_registered_blueprints}")
    require_tokens(
        bootstrap,
        [
            registration_token,
    ...
    require_tokens(
        ...
        [
            ...
            "grants[0].Facts[0], repairAbility",
    ...
    require_tokens(
        logic,
        [
            "Mutation occurs only at the ability-delivery boundary",
    ...
    require_tokens(
        ...
        [
            ...
            'Case("repair.transaction.wrecked-to-normal"',
            'Case("repair.transaction.repeated-cycles-reuse-tool"',
    ...
    require_tokens(
        ...
        [
            ...
            "Print maintenance PASS/FAIL matrix",
        ],
        "Development UI",
    )
