#!/usr/bin/env python3
"""Validate the strict standalone 0.0.27 Sprint 27 UMM ZIP."""
...
def main() -> int:
    ...
    with zipfile.ZipFile(args.archive) as archive:
        ...
        if info_json.get("Version") != "0.0.27":
            raise RuntimeError("Info.json does not declare version 0.0.27.")
    ...
    print("Sprint 27 standalone UMM package validation passed.")
