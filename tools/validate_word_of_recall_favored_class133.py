...
def validate(root: Path) -> None:
    ...
    baseline.baseline.DETERMINISTIC_TEST_COUNT = DETERMINISTIC_TEST_COUNT
    ...
    baseline.baseline.require_tokens(root / "docs/RELEASE-NOTES-0.0.133.md",
        "0.0.133-word-of-recall-favored-class", "favored class", "Favored Class",
