...
- `validate_repository.py` dispatches authoritative versions; `validate_sprint30.py` seals Sprint 30 requirements and `validate_sprint31.py` inherits them while validating the active early-catalog slice.
