...
DETERMINISTIC_TEST_COUNT = 1413
STATIC_KEY = "elementalTraits117"
TRAIT_GUID_PREFIX = "e117e1e0a17a4acec001"
MANIFEST_TOTAL = 1846
MANIFEST_ACTIVE = 1844
MANIFEST_RESERVED = 2
ELEMENTAL_TOTAL = 209
ELEMENTAL_ACTIVE = 208
...
def validate(root: Path) -> None:
    ...
    if len(traits) != 62 or any(entry.get("status") != "active"
            for entry in traits):
    ...
    expected_guids = {
        TRAIT_GUID_PREFIX + f"{index:012d}" for index in range(1, 63)
    }
