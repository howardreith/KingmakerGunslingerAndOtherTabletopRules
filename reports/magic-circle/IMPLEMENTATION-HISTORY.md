...
Expanded lifecycle checkpoint in progress: native pet/wall membership, Paladin class access, specialist unknown/stale-cache tests, and all-four saved circles plus purchased scroll/vendor/held-touch hydration. Guarded fixture scope is documented before any writes. Draft references compile against installed assemblies; full source/package and native qualification follow. No new production aura state or control policy was introduced.
