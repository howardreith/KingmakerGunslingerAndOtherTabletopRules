...
### 2026-08-20 continuation spear orientation checkpoint

Elven Branched Spear source `+Z` is now mapped to installed Longspear forward
`-Y`; three distinct project-owned BeltModel prefabs provide diagonal back
carry without changing the accepted source length, mechanics, or stable IDs.
The deterministic bundle is
`33EB89C74EC4AE7CDA5A8155224A449233904B74CB59FC453C24AE022EE3CB2A`
(126,658 bytes). All 1,162 tests and clean package gates passed. Guarded run
