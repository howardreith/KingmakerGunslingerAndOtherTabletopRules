...
2. Install the standalone `KingmakerGunslinger-0.0.96-firearm-audio-restoration.zip`
...
4. Launch the game through Steam and verify that Unity Mod Manager reports
   Kingmaker Gunslinger version 0.0.96 without a red/broken load indicator.
