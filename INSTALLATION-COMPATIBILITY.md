...
2. Install the standalone `KingmakerGunslinger-0.0.106-fatigue-authority-repair.zip`
...
4. Launch the game through Steam and verify that Unity Mod Manager reports
   Kingmaker Gunslinger version 0.0.106 without a red/broken load indicator.
...
active, Gunslinger 0.0.106 probes `CraftMagicItems.Main` and enables the bridge
...
the 0.0.106 candidate retains that accepted behavior. CMI always owns its top-level
...
1. Confirm CMI reports Kingmaker Gunslinger 0.0.106.
