    ...
    internal static class DevelopmentUi
    {
        ...
        internal static void Draw(UnityModManager.ModEntry modEntry)
        {
            ImmediateModeGui.Label(
                "Kingmaker Gunslinger - 0.0.140 URBAN-BARBARIAN / SHARE-TRANSMUTATION-INSTANT / ELEMENTAL-TRAITS / ELEMENTAL-FEATS / ELEMENTAL-HERITAGES / ELEMENTAL-RACES / GUNSLINGER-CLASS-OUTFIT-KITBASH / PROTECTION-FROM-ALIGNMENT-CONTROL-IMMUNITY / MARTIAL-PERFORMANCE-REPAIR-NOTIFICATIONS / ICON-ART-POLISH-ROUND-2 / ICON-ART-OVERHAUL / FATIGUE-AUTHORITY-REPAIR / SUMMON-SAME-TURN-ACTIVATION / OVERHAUL-SUMMON-MENU-FATIGUE-ESCALATION / STARTER-BOKKEN-COMBAT-LOG-ACADAMAE-TOGGLE / CRAFT-MAGIC-ITEMS-COMPATIBILITY / CRAFT-MAGIC-ITEMS-POST-HUMAN-REFINEMENT / CRAFT-MAGIC-ITEMS-AMMUNITION-UI-REPAIR / COMPATIBILITY-ATTRIBUTION-AUDIT / FIREARM-AUDIO-RESTORATION / IMMEDIATE-ACTION-ECONOMY / IN-HARMS-WAY-RUNTIME-REPAIR / EASTERN-FAVORED-COMPATIBILITY / HELPFUL-AID-ANOTHER / BODYGUARD-AC-BREAKDOWN / BODYGUARD-IN-HARMS-WAY / WEAPON-PRESENTATION-CALIBRATION / OVERNIGHT-GUNSLINGER-BUGFIXES / BROWN-FUR-HUMAN-REVIEW-REPAIR / EASTERN-WEAPONS / ELVEN-BRANCHED-SPEAR / EXPANDED-SUMMONING / SHIELD-OTHER / ACADAMAE-MODE-FATIGUE-ICON-REPAIR / FEATURE-MODULES / PAPER-CARTRIDGES-AUTO-RELOAD / RARE-FIREARMS / PISTOLERO-MUSKET-MASTER / FIREARM-NATIVE-WEAPON-RIGS / DODGE-EXPIRATION-R3  / CHARACTER-VISIBILITY-REPAIR  / SETTLEMENT-BUTTON-WIDTH / WORD-OF-RECALL-ORACLE / TELEPORT-POLISH-SPECIALIST / FIREARM-MAINTENANCE-REST-SAFETY / SCROLL-ITEM-ICONS / WORD-OF-RECALL-FAVORED-CLASS / MAGIC-CIRCLE-ALIGNMENT-SPELLS / RAPID-RELOAD-PROFICIENCY-GATE / RAPID-RELOAD-COMBAT-FEAT / BETTER-VENDORS-PROGRESSION / EXPANDED-SUMMONING-PHASE1 / FAVORED-CLASS-INTEGRATION");
            ImmediateModeGui.Label(
