...
namespace KingmakerGunslinger.Summoning
{
    internal static class ExpandedSummoningCatalog
    {
        ...
        {
            if (Creatures.Length != 71) throw new InvalidOperationException("Expanded Summoning unique creature count must be 71.");
            ...
            ValidateFamily(SummonFamily.Monster, 68, 378);
            ValidateFamily(SummonFamily.NaturesAlly, 61, 348);
        }
