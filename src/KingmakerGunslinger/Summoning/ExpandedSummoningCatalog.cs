...
namespace KingmakerGunslinger.Summoning
{
    internal static class ExpandedSummoningCatalog
    {
        ...
        {
            if (Creatures.Length != 74) throw new InvalidOperationException("Expanded Summoning unique creature count must be 74.");
            ...
            ValidateFamily(SummonFamily.NaturesAlly, 64, 357);
        }
