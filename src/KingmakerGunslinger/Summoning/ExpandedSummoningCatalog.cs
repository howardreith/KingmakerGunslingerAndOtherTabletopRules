...
namespace KingmakerGunslinger.Summoning
{
    internal static class ExpandedSummoningCatalog
    {
        ...
        {
            if (Creatures.Length != 80) throw new InvalidOperationException("Expanded Summoning unique creature count must be 80.");
            ...
            ValidateFamily(SummonFamily.NaturesAlly, 70, 393);
        }
