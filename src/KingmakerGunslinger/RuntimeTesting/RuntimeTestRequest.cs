    ...
    internal static class RuntimeTestRequestParser
    {
        ...
        private static string Validate(RuntimeTestRequest request, string loadedVersion)
        {
            ...
            bool workingSmoke = request.Scenario ==
                ...
                request.Scenario == RuntimeTestScenarioCatalog.SummonSameTurnActivation ||
                ...
                request.Scenario == RuntimeTestScenarioCatalog.MusketMasterMechanicsAndStarter;
                ...
                RuntimeTestScenarioCatalog.ObserveFeatureModuleSettings)
            {
                ...
                if (request.Parameters == null || request.Parameters.Count != 9 ||
                    ...
                    request.Parameters.Property("elvenBranchedSpears") == null ||
