...
namespace KingmakerGunslinger.RuntimeTesting
{
    internal static class RuntimeTestScenarioCatalog
    {
        ...
        internal const string DisposableTeleportationSpecialistCache = "disposable-teleportation-specialist-cache";
        ...
        internal const string DisposableBrownFurBonusCarriers =
            "disposable-brown-fur-bonus-carriers";
        internal const string DisposableBrownFurShareTargeting =
            "disposable-brown-fur-share-targeting";
        internal const string DisposableBrownFurTransmutationSupremacy =
        ...
        internal const string WorkingSaveBrownFurOffVerifyCleanup =
        ...
        internal const string WorkingSaveCreatorVisualLifecycle =
        ...
        internal const string WeaponPresentationEvidence =
        ...
        internal const string WeaponPresentationTransitionMotionEvidence =
            "weapon-presentation-transition-motion-evidence";
        internal const string WeaponPresentationReloadEvidence =
            "weapon-presentation-reload-evidence";
        internal const string WeaponPresentationBodyMatrixEvidence =
        ...
        private static readonly HashSet<string> Allowed =
            new HashSet<string>(StringComparer.Ordinal)
            {
                ...
                WorkingSaveCreatorVisualLifecycle,
                ...
                WeaponPresentationReloadEvidence,
                ...
                DisposableTeleportationSpecialistCache,
