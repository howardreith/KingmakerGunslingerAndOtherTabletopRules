        ...
        internal static IReadOnlyList<ElementalRaceDefinition> Ordered()
        {
            var result = new[]
            {
                new ElementalRaceDefinition(ElementalRaceKind.Ifrit, "Ifrit",
                    "Ifrits carry the ancestry of native outsiders touched by elemental fire. Kingmaker gives them the same creature-type interactions as its Aasimar and Tieflings. They are quick and compelling but often impulsive. Ifrits gain +2 Dexterity, +2 Charisma, -2 Wisdom, fire resistance 5, Keen Senses, +1 DC with Fire spells, and Burning Hands once per day as a Charisma-based spell-like ability using total character level.",
                ...
                new ElementalRaceDefinition(ElementalRaceKind.Oread, "Oread",
                    "Oreads carry the ancestry of native outsiders touched by elemental earth. Kingmaker gives them the same creature-type interactions as its Aasimar and Tieflings. They gain +2 Strength, +2 Wisdom, -2 Charisma, acid resistance 5, Keen Senses, +1 DC with Acid spells, and Stone Fist once per day using total character level. Their 20-foot Slow and Steady movement is not reduced by armor or encumbrance.",
                ...
                new ElementalRaceDefinition(ElementalRaceKind.Sylph, "Sylph",
                    "Sylphs carry the ancestry of native outsiders touched by elemental air. Kingmaker gives them the same creature-type interactions as its Aasimar and Tieflings. They gain +2 Dexterity, +2 Intelligence, -2 Constitution, electricity resistance 5, Keen Senses, +1 DC with Electricity spells, and Feather Step once per day using total character level. Feather Step is Kingmaker's practical substitute for Feather Fall.",
                ...
                new ElementalRaceDefinition(ElementalRaceKind.Undine, "Undine",
                    "Undines carry the ancestry of native outsiders touched by elemental water. Kingmaker gives them the same creature-type interactions as its Aasimar and Tieflings. They gain +2 Dexterity, +2 Wisdom, -2 Strength, cold resistance 5, Keen Senses, +1 DC with Cold spells, and Hydraulic Push once per day using total character level. Kingmaker has no ordinary player swimming system, so swim clauses have no mechanical effect.",
