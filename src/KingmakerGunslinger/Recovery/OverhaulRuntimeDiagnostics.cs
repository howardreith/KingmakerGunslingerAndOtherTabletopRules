...
{
    /// <summary>
    /// Process-local counters for the player-facing overhaul ability. These diagnostics
    /// never participate in item persistence or gameplay decisions.
    /// </summary>
    internal static class OverhaulRuntimeDiagnostics
    {
        ...
        private static string _lastResult =
            "No Overhaul Test Musket delivery has completed in this process.";
        ...
        internal static void Record(FirearmOverhaulRuntimeResult result)
        {
            if (result == null)
            {
