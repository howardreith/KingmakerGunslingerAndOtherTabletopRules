    ...
    internal static class WeaponVisualVariantCatalog
    {
        ...
        private static readonly Dictionary<string, string> Variants =
            new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                // Better Vendors progression variants share their family's
                // existing generic visual, exactly like the canonical +1 items.
                { "KMG.Firearms.PistolPlus2Item", PistolService },
                { "KMG.Firearms.PistolPlus3Item", PistolService },
                { "KMG.Firearms.PistolPlus4Item", PistolService },
                { "KMG.Firearms.PistolPlus5Item", PistolService },
                { "KMG.Firearms.ReliablePistolPlus1Item", PistolService },
                { "KMG.Firearms.ReliablePistolPlus2Item", PistolService },
                { "KMG.Firearms.ReliablePistolPlus3Item", PistolService },
                { "KMG.Firearms.ReliablePistolPlus4Item", PistolService },
                { "KMG.Firearms.ReliablePistolPlus5Item", PistolService },
                { "KMG.Firearms.MusketPlus2Item", MusketService },
                { "KMG.Firearms.MusketPlus3Item", MusketService },
                { "KMG.Firearms.MusketPlus4Item", MusketService },
                { "KMG.Firearms.MusketPlus5Item", MusketService },
                { "KMG.Firearms.ReliableMusketPlus1Item", MusketService },
                { "KMG.Firearms.ReliableMusketPlus2Item", MusketService },
                { "KMG.Firearms.ReliableMusketPlus3Item", MusketService },
                { "KMG.Firearms.ReliableMusketPlus4Item", MusketService },
                { "KMG.Firearms.ReliableMusketPlus5Item", MusketService },
                { "KMG.Firearms.BlunderbussPlus2Item", BlunderbussService },
                { "KMG.Firearms.BlunderbussPlus3Item", BlunderbussService },
                { "KMG.Firearms.BlunderbussPlus4Item", BlunderbussService },
                { "KMG.Firearms.BlunderbussPlus5Item", BlunderbussService },
                { "KMG.Firearms.ReliableBlunderbussPlus1Item", BlunderbussService },
                { "KMG.Firearms.ReliableBlunderbussPlus2Item", BlunderbussService },
                { "KMG.Firearms.ReliableBlunderbussPlus3Item", BlunderbussService },
                { "KMG.Firearms.ReliableBlunderbussPlus4Item", BlunderbussService },
                { "KMG.Firearms.ReliableBlunderbussPlus5Item", BlunderbussService },
                { "KMG.ElvenBranchedSpear.Plus2Item", SpearClassic },
                { "KMG.ElvenBranchedSpear.Plus3Item", SpearClassic },
                { "KMG.ElvenBranchedSpear.Plus4Item", SpearClassic },
                { "KMG.ElvenBranchedSpear.Plus5Item", SpearClassic },
                { "KMG.EasternWeapons.Wakizashi.Plus2Item", WakizashiClassic },
                { "KMG.EasternWeapons.Wakizashi.Plus3Item", WakizashiClassic },
                { "KMG.EasternWeapons.Wakizashi.Plus4Item", WakizashiClassic },
                { "KMG.EasternWeapons.Wakizashi.Plus5Item", WakizashiClassic },
                { "KMG.EasternWeapons.Katana.Plus2Item", KatanaClassic },
                { "KMG.EasternWeapons.Katana.Plus3Item", KatanaClassic },
                { "KMG.EasternWeapons.Katana.Plus4Item", KatanaClassic },
                { "KMG.EasternWeapons.Katana.Plus5Item", KatanaClassic },
                { "KMG.EasternWeapons.Nodachi.Plus2Item", NodachiClassic },
                { "KMG.EasternWeapons.Nodachi.Plus3Item", NodachiClassic },
                { "KMG.EasternWeapons.Nodachi.Plus4Item", NodachiClassic },
                { "KMG.EasternWeapons.Nodachi.Plus5Item", NodachiClassic }
            };
