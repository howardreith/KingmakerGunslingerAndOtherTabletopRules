namespace KingmakerGunslinger.Spells.Teleportation
{
    ...
    //     need a confirmation (Greater Teleport and Recall settle directly);
    //   - an in-flight cast blocks everything until it settles.
    internal static class TeleportBeginPolicy
    {
        internal static bool IsDirect(TeleportSpellKind spell)
        { return spell == TeleportSpellKind.GreaterTeleport || spell == TeleportSpellKind.WordOfRecall; }
            ...
            bool confirmationPresenterAvailable, TeleportSpellKind spell)
        {
            ...
            if (IsDirect(spell)) return true;
            return spell == TeleportSpellKind.Teleport && confirmationPresenterAvailable;
        }
