...
namespace KingmakerGunslinger.FavoredClass
{
    ...
    internal sealed class FavoredClassRevelationTarget
    {
        internal FavoredClassRevelationTarget(string key, string title, string mystery,
            ...
            string[] excludedRanks, string[] includedTiers)
        {
            Key = key;
            Title = title;
            Mystery = mystery;
            ...
            IncludedTiers = includedTiers ?? new string[0];
        }
        ...
        /// <summary>
        /// Player-facing audited thresholds that stay at the actual oracle
        /// level (null when the revelation has none).
        /// </summary>
        ...
        /// <summary>"blueprint guid|rank type" reads the audit holds back.</summary>
        internal string[] ExcludedRanks { get; private set; }

        /// <summary>
        /// "blueprint guid|rank type" tier selections the audit implements;
        /// every other tier selection is held back.
        /// </summary>
        internal string[] IncludedTiers { get; private set; }
    ...
    internal static class FavoredClassRevelationManifest
    {
        ...
        private static readonly FavoredClassRevelationTarget[] Entries =
        {
            ...
            new FavoredClassRevelationTarget("SpiritOfTheWarrior", "Spirit of the Warrior", "Ancestor",
                ...
                null, new[] { "90fc3e05688f4b9dad36bc7c49221d74|StatBonus" }, null),
            new FavoredClassRevelationTarget("SpiritShield", "Spirit Shield", "Ancestor",
                new[] { "c9309afa08da4b579b06d06ea8e144c6" },
                "A on buff, B", "the ranged miss chance gained at 13th level",
                null, null, null),
            ...
            new FavoredClassRevelationTarget("Battlecry", "Battlecry", "Battle",
                ...
                "B", "the +2 bonus at 10th level",
                null, new[] { "bbc83bf7650b4eb5891fce8ddf7cfe53|StatBonus" }, null),
            ...
            new FavoredClassRevelationTarget("IronSkin", "Iron Skin", "Battle",
                ...
                "C", "the extra daily use at 15th level",
                null, null, null),
            ...
            new FavoredClassRevelationTarget("ScaledToughness", "Scaled Toughness", "Dragon",
                ...
                "A", "the extra daily use at 13th level",
                null, null, null),
            new FavoredClassRevelationTarget("BreathWeapon", "Breath Weapon", "Dragon",
                ...
                "A,B,C", "the final breath weapon at 20th level",
                null, null, null),
            ...
            new FavoredClassRevelationTarget("IceArmor", "Ice Armor", "Waves",
                ...
                "A,B", "the damage reduction gained at 13th level",
                null, null, null),
            ...
            new FavoredClassRevelationTarget("GiftOfClawAndHorn", "Gift of Claw and Horn", "Nature",
                ...
                null, null, new[]
                {
                    "32ed966b5d5e45c090bd4c042ec0b999|StatBonus",
                    "a033db900df14699916cb0ab7630359b|StatBonus",
                    "1cb14a5b0ff04e80969bbd9ad31e4ef6|StatBonus"
                }),
            ...
            new FavoredClassRevelationTarget("RaiseTheDead", "Raise the Dead", "Bones",
                ...
                "A tier", "the extra daily use at 10th level and the ability gained at 15th level",
                null, null, new[] { "af8400833a314a22bc8d743e5139c2a6|DamageBonus" }),
