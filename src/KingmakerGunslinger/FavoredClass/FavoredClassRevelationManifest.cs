    ...
    internal static class FavoredClassRevelationManifest
    {
        ...
        private static readonly FavoredClassRevelationTarget[] Entries =
        {
            ...
            new FavoredClassRevelationTarget("UndeadServitude", "Undead Servitude", "Bones",
                ...
                "C", null,
                null, null),
            // The formerly deferred threshold-only revelations (family D: the
            // revelation's own level gates; A: its own breakpoint tables),
            // appended so every earlier target keeps its position.
            new FavoredClassRevelationTarget("TemporalCelerity", "Temporal Celerity", "Time",
                new[] { "f968fd2c8d484833b82d5f49f8a67d26" },
                "D", null,
                null, null),
            new FavoredClassRevelationTarget("CinderDance", "Cinder Dance", "Flame",
                new[] { "e347777d26464759b7a2792c6ed72e6b" },
                "D", null,
                null, null),
            new FavoredClassRevelationTarget("MoltenSkin", "Molten Skin", "Flame",
                new[] { "09b82149f4734027b7179269264fed5f" },
                "A,D", null,
                null, null),
            new FavoredClassRevelationTarget("WarSight", "War Sight", "Battle",
                new[] { "2fdddfc641f34292a1fc49a73fe2569a" },
                "D", null,
                null, null),
            // A selection: the chosen weapon's own leaf holds the gates.
            new FavoredClassRevelationTarget("WeaponMastery", "Weapon Mastery", "Battle",
                new[] { "22b9d037500943d298c161d90b225ba3" },
                "D on the chosen weapon", null,
                null, null),
            new FavoredClassRevelationTarget("SparkSkin", "Spark Skin", "Wind",
                new[] { "0e885ebcaed94e21a7257a077bc66888" },
                "A,D", null,
                null, null),
            new FavoredClassRevelationTarget("DragonSenses", "Dragon Senses", "Dragon",
                new[] { "dbe0104d605046d2adae674a7c9b020b" },
                "A,D", null,
                null, null),
            new FavoredClassRevelationTarget("DraconicResistances", "Draconic Resistances", "Dragon",
                new[]
                {
                    "b3592cbcb99c438d9bece320cb12f0d1",
                    "82ac01a6361a49c4b81cc6360c66187f",
                    "b9f5745d3f69472ba245cccf681efe8c",
                    "a11e3b82dfef47438b72bb7af800038c",
                    "c97dea952e95480990a28a3d9d8bd709",
                    "94e59f9ceba04d889fb6c18a5e8ce8d7",
                    "c7889ec148be4b6f9a3a65fbee034d08",
                    "196ba3ff948a49c68a135160e935d748",
                    "8aae32d5c8a04cf19ab3021b15655329",
                    "a87a99acbd0d4dee87a1ae0615fb56b5"
                },
                "A", null,
                null, null),
            new FavoredClassRevelationTarget("FluidNature", "Fluid Nature", "Waves",
                new[] { "268168388398418fbd9acc92a4f3a7ae" },
                "D", null,
                null, null),
            new FavoredClassRevelationTarget("FreezingSpells", "Freezing Spells", "Waves",
                new[] { "0884cc57071c4e779aaf5ca4308825ba" },
                "D", null,
                null, null),
            new FavoredClassRevelationTarget("IcySkin", "Icy Skin", "Waves",
                new[] { "deeb247de39f4f359f9821b91c74acf5" },
                "A,D", null,
                null, null),
            new FavoredClassRevelationTarget("SpiritOfNature", "Spirit of Nature", "Nature",
                new[] { "7471318aed824ef49892ec869305cf7e" },
                "A on buff", null,
                null, null),
            new FavoredClassRevelationTarget("NearDeath", "Near Death", "Bones",
                new[] { "8fdfbde04acd4e7798b383e21a1dc6b0" },
                "A,D", null,
                null, null),
            new FavoredClassRevelationTarget("ResistLife", "Resist Life", "Bones",
                new[] { "4236f6aba59048f2818ae45357560460" },
                "A", null,
                null, null),
        };
