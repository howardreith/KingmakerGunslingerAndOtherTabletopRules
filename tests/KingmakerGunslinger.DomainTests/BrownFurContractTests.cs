    ...
    internal static class BrownFurContractTests
    {
        ...
        internal static void RuntimeResolverUsesExactOptionalContract()
        {
            ...
            foreach (string token in new[] {
                ...
                "supremacy-earth-tremor-variant-durations",
                "supremacy-instant-permanent-selector-noops",
                ...
                "NamedBooleanFields", "NoOpDurationCounts",
            ...
            foreach (string token in new[] {
                ...
                "dispelRule.Bonus = 1000", "DispelCheckRoll",
                "DispelCasterLevel", "DispelDc", "DispelBonus",
