...
namespace KingmakerGunslinger.DomainTests
{
    internal static class ElementalTreacherousPolicyTests
    {
        ...
        internal static void UnknownEvidenceFailsClosed()
        {
            ...
            Assertions.False(ElementalTreacherousPolicy.EligibilityQualified,
                "The delegated rule still requires native ground and full trait integration qualification.");
            Assertions.False(ElementalAlternateTraitPolicy.Find(ElementalAlternateTraitId.TreacherousEarth).IsPublished,
                "The incomplete trait integration stays outside ordinary character publication.");
        }
    }
}
