...
namespace KingmakerGunslinger.DomainTests
{
    internal static class ElvenBranchedSpearCatalogTests
    {
        ...
        internal static void ReleaseIdentityIsSpearSpecific()
        {
            ...
            Assertions.True(info.Contains("\"Version\": \"0.0.91\"") &&
                props.Contains("<KmgVersion>0.0.91</KmgVersion>") &&
                props.Contains("<KmgInformationalVersion>0.0.91-bodyguard-ac-breakdown</KmgInformationalVersion>") &&
                assembly.Contains("AssemblyVersion(\"0.0.91\")") &&
                assembly.Contains("AssemblyFileVersion(\"0.0.91\")") &&
                assembly.Contains("AssemblyInformationalVersion(\"0.0.91-bodyguard-ac-breakdown\")"),
            ...
            Assertions.True(runtime.Contains("active version 0.0.91") &&
                localBuild.Contains("active version 0.0.91") &&
                localBuild.Contains("local-runtime\\0.0.91"),
