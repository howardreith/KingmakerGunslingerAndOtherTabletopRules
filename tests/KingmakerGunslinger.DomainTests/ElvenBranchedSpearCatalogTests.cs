...
namespace KingmakerGunslinger.DomainTests
{
    internal static class ElvenBranchedSpearCatalogTests
    {
        ...
        internal static void ReleaseIdentityIsSpearSpecific()
        {
            ...
            Assertions.True(info.Contains("\"Version\": \"0.0.86\"") &&
                props.Contains("<KmgVersion>0.0.86</KmgVersion>") &&
                props.Contains("<KmgInformationalVersion>0.0.86-urban-barbarian-human-review-repair-3</KmgInformationalVersion>") &&
                assembly.Contains("AssemblyVersion(\"0.0.86\")") &&
                assembly.Contains("AssemblyFileVersion(\"0.0.86\")") &&
                assembly.Contains("AssemblyInformationalVersion(\"0.0.86-urban-barbarian-human-review-repair-3\")"),
            ...
            Assertions.True(runtime.Contains("active version 0.0.86") &&
                localBuild.Contains("active version 0.0.86") &&
                localBuild.Contains("local-runtime\\0.0.86"),
