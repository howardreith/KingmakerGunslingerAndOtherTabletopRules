    ...
    internal static class ElvenBranchedSpearCatalogTests
    {
        ...
        internal static void ReleaseIdentityIsSpearSpecific()
        {
            ...
            Assertions.True(info.Contains("\"Version\": \"0.0.135\"") &&
                ...
                props.Contains("<KmgInformationalVersion>0.0.135-magic-circle-alignment-spells</KmgInformationalVersion>") &&
                assembly.Contains("AssemblyVersion(\"0.0.135\")") &&
                assembly.Contains("AssemblyFileVersion(\"0.0.135\")") &&
                assembly.Contains("AssemblyInformationalVersion(\"0.0.135-magic-circle-alignment-spells\")"),
