...
namespace KingmakerGunslinger.DomainTests
{
    internal static class ElvenBranchedSpearCatalogTests
    {
        ...
        internal static void ReleaseIdentityIsSpearSpecific()
        {
            ...
            Assertions.True(info.Contains("\"Version\": \"0.0.92\"") &&
                props.Contains("<KmgVersion>0.0.92</KmgVersion>") &&
                props.Contains("<KmgInformationalVersion>0.0.92-helpful-aid-another</KmgInformationalVersion>") &&
                assembly.Contains("AssemblyVersion(\"0.0.92\")") &&
                assembly.Contains("AssemblyFileVersion(\"0.0.92\")") &&
                assembly.Contains("AssemblyInformationalVersion(\"0.0.92-helpful-aid-another\")"),
            ...
            Assertions.True(runtime.Contains("active version 0.0.92") &&
                localBuild.Contains("active version 0.0.92") &&
                localBuild.Contains("local-runtime\\0.0.92"),
