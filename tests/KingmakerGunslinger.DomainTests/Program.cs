...
namespace KingmakerGunslinger.DomainTests
{
    internal static partial class Program
    {
        private static readonly TestCase[] Cases =
        {
            ...
            Case("feature-settings.schemas-zero-through-nine", FeatureModuleSettingsTests.SchemasZeroThroughNinePreserveValuesAndElementalIntent),
            Case("urban-barbarian.rage-inventory-contract", UrbanBarbarianInventoryContractTests.GuardedInventoryIsReadOnlyAndComplete),
            Case("feature-settings.two-thousand-forty-eight-combinations", FeatureModuleSettingsTests.TwoThousandFortyEightCombinationsRoundTrip),
            ...
            Case("feature-settings.matrix-counts", FeatureModuleSettingsTests.ElevenModuleMatrixCountsAreExact),
            Case("feature-modules.publication-plans", FeatureModuleSettingsTests.PublicationPlansAreIndependent),
            Case("feature-modules.runtime-matrix", FeatureModuleSettingsTests.RuntimeMatrixUsesAuthoritativeElevenModuleCatalog),
