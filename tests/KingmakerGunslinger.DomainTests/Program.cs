...
namespace KingmakerGunslinger.DomainTests
{
    internal static partial class Program
    {
        private static readonly TestCase[] Cases =
        {
            ...
            Case("expanded-summoning.menu-scale-projection", ExpandedSummoningMenuScalabilityTests.ProjectedScaleMatchesTheMeasuredBaseline),
            ...
            Case("expanded-summoning.menu-scale-stretch-probe", ExpandedSummoningMenuScalabilityTests.StretchProbeStaysBounded),
