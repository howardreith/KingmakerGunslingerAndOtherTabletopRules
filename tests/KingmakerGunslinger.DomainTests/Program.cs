...
namespace KingmakerGunslinger.DomainTests
{
    internal static partial class Program
    {
        private static readonly TestCase[] Cases =
        {
            ...
            Case("rapid-reload-evidence.intended-grants-are-not-evidence", RapidReloadGateEvidenceTests.IntendedGrantsAreNeverEvidence),
            ...
            Case("rapid-reload-evidence.archetype-scope-must-narrow", RapidReloadGateEvidenceTests.ArchetypeScopeChangeDemandsRealScopeNarrowing),
