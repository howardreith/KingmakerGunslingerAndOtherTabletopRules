...
namespace KingmakerGunslinger.DomainTests
{
    internal static partial class Program
    {
        private static readonly TestCase[] Cases =
        {
            ...
            Case("broken-sequence.construction-repaired-never-locked", BrokenSequenceInterruptionTests.ConstructionRepairedWeaponNeverLocked),
            Case("broken-sequence.construction-invalid-condition-throws", BrokenSequenceInterruptionTests.ConstructionInvalidConditionFailsClosed),
