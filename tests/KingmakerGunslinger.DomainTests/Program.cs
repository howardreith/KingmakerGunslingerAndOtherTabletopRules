...
namespace KingmakerGunslinger.DomainTests
{
    internal static partial class Program
    {
        private static readonly TestCase[] Cases =
        {
            ...
            Case("magic-circle.family-general", MagicCircleFamilyAccessTests.GeneralFamilyGrantsItsFourChildren),
            Case("magic-circle.family-restricted", MagicCircleFamilyAccessTests.RestrictedFamiliesDoNotBroadenScrollAccess),
            Case("magic-circle.family-unpublished", MagicCircleFamilyAccessTests.AbsentPublicationDoesNotGrantAccess),
            Case("magic-circle.family-foreign-parent", MagicCircleFamilyAccessTests.ForeignParentsCannotGrantOwnedVariants),
            Case("magic-circle.family-foreign-child", MagicCircleFamilyAccessTests.ForeignChildrenAndMalformedRootsAreIgnored),
            ...
            Case("teleportation.oracle.OracleLevelSixMergePreservesForeignEntriesOnce", TeleportationOracleRecallTests.OracleLevelSixMergePreservesForeignEntriesOnce),
            Case("teleportation.oracle.OracleMergeFailsClosedOnNullEntries", TeleportationOracleRecallTests.OracleMergeFailsClosedOnNullEntries),
            ...
            Case("teleportation.favoredClass.VariantsMergePublishesOnceAndPreservesEntries", WordOfRecallFavoredClassTests.VariantsMergePublishesOnceAndPreservesEntries),
            ...
            Case("teleportation.favoredClass.AlreadyCorrectArrayIsNotReplaced", FavoredClassVariantsTransactionTests.AlreadyCorrectArrayIsNotReplaced),
            Case("teleportation.favoredClass.FailureAfterAssignmentRestoresOwnedState", FavoredClassVariantsTransactionTests.FailureAfterAssignmentRestoresOwnedState),
            Case("teleportation.favoredClass.ForeignMutationAfterAssignmentRefusesRestore", FavoredClassVariantsTransactionTests.ForeignMutationAfterAssignmentRefusesRestore),
            Case("teleportation.favoredClass.NullEntryFailsClosedBeforeAnyWrite", FavoredClassVariantsTransactionTests.NullEntryFailsClosedBeforeAnyWrite),
            Case("teleportation.favoredClass.CacheWriterFailureRollsBackInstalledArray", FavoredClassVariantsTransactionTests.CacheWriterFailureRollsBackInstalledArray),
            Case("teleportation.favoredClass.WriterThatChangesTargetThenThrowsIsRolledBack", FavoredClassVariantsTransactionTests.WriterThatChangesTargetThenThrowsIsRolledBack),
            Case("teleportation.favoredClass.RestorationFailurePreservesOriginalAndRestorationFailures", FavoredClassVariantsTransactionTests.RestorationFailurePreservesOriginalAndRestorationFailures),
            Case("teleportation.favoredClass.RestorationRefusalDuringPublicationFailureRefuses", FavoredClassVariantsTransactionTests.RestorationRefusalDuringPublicationFailureRefuses),
            Case("teleportation.favoredClass.ResolutionDistinguishesAbsentMalformedAndAmbiguous", FavoredClassVariantsTransactionTests.ResolutionDistinguishesAbsentMalformedAndAmbiguous),
            Case("teleportation.favoredClass.MalformedSelectionContractTargetsNeverResolve", FavoredClassVariantsTransactionTests.MalformedSelectionContractTargetsNeverResolve),
            ...
            Case("teleportation.presentation.ArrivalMessagesUseOutcomeAppropriateSentences", TeleportationContextTests.ArrivalMessagesUseOutcomeAppropriateSentences),
            Case("teleportation.presentation.GreaterTeleportSuccessAnnouncementIsSuppressed", TeleportationContextTests.GreaterTeleportSuccessAnnouncementIsSuppressed),
            ...
            Case("teleportation.mishap.NativeStateSurroundsEveryExactDamagePacket", TeleportationMishapTests.NativeStateSurroundsEveryExactDamagePacket),
            Case("teleportation.mishap.NewNativeDeathExcludesSubsequentMishaps", TeleportationMishapTests.NewNativeDeathExcludesSubsequentMishaps),
            Case("teleportation.mishap.PrecedingIndirectDamageCanInvalidateTheNextTarget", TeleportationMishapTests.PrecedingIndirectDamageCanInvalidateTheNextTarget),
            Case("teleportation.mishap.UnconsciousLivingUnitsStillTakeEachMishap", TeleportationMishapTests.UnconsciousLivingUnitsStillTakeEachMishap),
            Case("teleportation.mishap.InvalidRollsAndNativeErrorsAreNotSilentlyReplaced", TeleportationMishapTests.InvalidRollsAndNativeErrorsAreNotSilentlyReplaced),
            ...
            Case("teleportation.DestinationReasonsAreExact", TeleportationContextTests.DestinationReasonsAreExact),
            Case("teleportation.ForbiddenCatalogIsStableAndVersioned", TeleportationContextTests.ForbiddenCatalogIsStableAndVersioned),
            Case("teleportation.ActionsOrderAndCounts", TeleportationContextTests.ActionsOrderAndCounts),
            Case("teleportation.RecallUsesOnlyLockedDestination", TeleportationContextTests.RecallUsesOnlyLockedDestination),
            Case("teleportation.DistinctBooksAndEquivalentVariants", TeleportationContextTests.DistinctBooksAndEquivalentVariants),
            Case("teleportation.ReopeningRecalculatesAvailability", TeleportationContextTests.ReopeningRecalculatesAvailability),
            Case("teleportation.EveryWorldMapBlockOmitsActions", TeleportationContextTests.EveryWorldMapBlockOmitsActions),
            ...
            Case("teleportation.AlternateSeverityAndInjectedSelection", TeleportationContextTests.AlternateSeverityAndInjectedSelection),
            Case("teleportation.NoAlternateDoesNotRollOrPromote", TeleportationContextTests.NoAlternateDoesNotRollOrPromote),
            Case("teleportation.EveryRulesOutcomeConsumesOneUse", TeleportationContextTests.EveryRulesOutcomeConsumesOneUse),
            Case("teleportation.MishapsCoverLivingTravelersAndAccumulate", TeleportationContextTests.MishapsCoverLivingTravelersAndAccumulate),
            Case("teleportation.DefensiveMishapCapStaysSpentAtOrigin", TeleportationContextTests.DefensiveMishapCapStaysSpentAtOrigin),
            Case("teleportation.ExactSpellsNeverRollDestinationOrDamage", TeleportationContextTests.ExactSpellsNeverRollDestinationOrDamage),
            Case("teleportation.RulesFailureLoggingCannotRefund", TeleportationContextTests.RulesFailureLoggingCannotRefund),
            Case("teleportation.arrival.CrossedBoundariesOnly", TeleportationArrivalTests.CrossedBoundariesOnly),
            Case("teleportation.arrival.PartialStartAndRevisits", TeleportationArrivalTests.PartialStartAndRevisits),
            Case("teleportation.arrival.NativeStopsDoNotCountBeyondArrival", TeleportationArrivalTests.NativeStopsDoNotCountBeyondArrival),
            Case("teleportation.arrival.NonPointEndsAndInactivePointsExcluded", TeleportationArrivalTests.NonPointEndsAndInactivePointsExcluded),
            Case("teleportation.arrival.CompletionIsIdempotentAndRequiresProgress", TeleportationArrivalTests.CompletionIsIdempotentAndRequiresProgress),
            Case("teleportation.arrival.InvalidGeometryFailsClosed", TeleportationArrivalTests.InvalidGeometryFailsClosed),
            Case("teleportation.arrival.SaveOwnedObserverContract", TeleportationArrivalTests.SaveOwnedObserverContract),
            Case("teleportation.exploration.StationaryArrivalSuppressesRepeatedTicks", TeleportationExplorationTests.StationaryArrivalSuppressesRepeatedTicks),
            Case("teleportation.exploration.NativeWalkingReleases", TeleportationExplorationTests.NativeWalkingReleases),
            Case("teleportation.exploration.ChangedPointOrMapReleases", TeleportationExplorationTests.ChangedPointOrMapReleases),
            Case("teleportation.exploration.TravelWhileDisabledDoesNotRetainOldSuppression", TeleportationExplorationTests.TravelWhileDisabledDoesNotRetainOldSuppression),
            Case("teleportation.exploration.SavedBoundaryRoundTripsInvariantly", TeleportationExplorationTests.SavedBoundaryRoundTripsInvariantly),
            ...
            Case("elemental-traits.native-turn-owned-action-costs", ElementalCharacterCreationRoutingTests.NativeTraitTurnFixtureOwnsActionsAndRestoration),
            ...
            Case("favored-class.rank-divisor-four-decomposition", FavoredClassRankPolicyTests.DivisorFourDecompositionMatchesHostFacts),
            Case("favored-class.rank-golden-examples", FavoredClassRankPolicyTests.GoldenExamplesMatchTheCharter),
            Case("favored-class.rank-undine-monk-mixed", FavoredClassRankPolicyTests.UndineMonkMixedRateBundle),
            Case("favored-class.rank-every-rate-walk", FavoredClassRankPolicyTests.EveryRateAlternatesAndClosesAtItsCeiling),
            Case("favored-class.rank-divisor-six-twenty", FavoredClassRankPolicyTests.UncappedDivisorSixDoesNotStopAtEighteen),
            Case("favored-class.rank-inconsistent-fails-closed", FavoredClassRankPolicyTests.InconsistentRanksFailClosedAndBenefitStaysCapped),
            Case("favored-class.rank-invalid-rejected", FavoredClassRankPolicyTests.InvalidRatesAndCountsAreRejected),
            Case("favored-class.catalog-inventory-counts", FavoredClassCatalogTests.InventoryReconcilesToTheCharterCounts),
            Case("favored-class.catalog-dispositions", FavoredClassCatalogTests.DispositionsMatchTheAdoptedScope),
            Case("favored-class.catalog-row-effects", FavoredClassCatalogTests.EveryScheduledRowReachesAnEffectAndNoOtherRowDoes),
            Case("favored-class.catalog-rates-caps", FavoredClassCatalogTests.RatesCapsAndSourceCorrectionsAreExact),
            Case("favored-class.catalog-distinct-variants", FavoredClassCatalogTests.DistinctVariantsKeepTheirOwnRatesAndProfiles),
            Case("favored-class.catalog-adaptation-disclosure", FavoredClassCatalogTests.AdaptationsDiscloseTheirOmissions),
            Case("favored-class.eligibility-race-menus", FavoredClassEligibilityTests.GunslingerMenusForEverySourceAddressableRace),
            Case("favored-class.eligibility-alias-routes", FavoredClassEligibilityTests.AliasRoutesNeverDuplicateOrMultiply),
            Case("favored-class.eligibility-mostly-human", FavoredClassEligibilityTests.MostlyHumanGrantsHumanAccessOnlyToGeniekin),
            Case("favored-class.eligibility-bounded-graph", FavoredClassEligibilityTests.UnknownCyclicAndDuplicateEvidenceIsBounded),
            Case("favored-class.eligibility-absent-provider", FavoredClassEligibilityTests.AbsentProvidersRemoveOnlyTheirRoute),
            Case("favored-class.eligibility-race-identities", FavoredClassEligibilityTests.RaceIdentitiesAreExactAndComplete),
            Case("favored-class.host-identities-merge-ids", FavoredClassHostContractTests.HostIdentitiesDeriveFromTheClassGuid),
            Case("favored-class.host-exact-binary", FavoredClassHostContractTests.ExactQualifiedBinaryIsAccepted),
            Case("favored-class.host-absent-disabled", FavoredClassHostContractTests.AbsentDisabledAndUnloadedHostsAreInactive),
            Case("favored-class.host-same-version-rejected", FavoredClassHostContractTests.SameVersionDifferentBinaryIsRejected),
            Case("favored-class.host-readiness", FavoredClassHostContractTests.ReadinessRequiresCompleteInitializationAndGunslinger),
            Case("favored-class.leaf-manifest-tail", FavoredClassLeafCatalogTests.ManifestTailIsExactlyTheCommittedIdentities),
            Case("favored-class.leaf-identities", FavoredClassLeafCatalogTests.EveryLeafHasACommittedIdentity),
            Case("favored-class.leaf-capacity-disclosure", FavoredClassLeafCatalogTests.LeafCapacitiesAndDisclosureFollowThePolicy),
            Case("favored-class.status-registry", FavoredClassLeafCatalogTests.StatusRegistryLogsEachStateOnce),
            Case("favored-class.gunslinger-counter-capacities", FavoredClassGunslingerCoreTests.EveryGunslingerCounterHasExactCapacities),
            Case("favored-class.gunslinger-conditions-disclosed", FavoredClassGunslingerCoreTests.ConditionsAreDisclosed),
            Case("favored-class.misfire-reduction-last", FavoredClassGunslingerCoreTests.MisfireReductionAppliesLastWithItsFloor),
            Case("favored-class.scatter-effective-threshold", FavoredClassGunslingerCoreTests.ScatterAggregateUsesTheEffectiveThreshold),
            Case("favored-class.confirmation-better-bonus", FavoredClassGunslingerCoreTests.ConfirmationPreservesTheBetterBonus),
            Case("favored-class.initiative-active-deed", FavoredClassGunslingerCoreTests.InitiativeImprovesOnlyTheActiveDeed),
            Case("favored-class.mechanics-authoritative-sites", FavoredClassGunslingerCoreTests.MechanicsLiveInTheAuthoritativeCalculations),
            Case("favored-class.settings-valid-file", FavoredClassSettingsTests.ValidFileSetsEveryControl),
            Case("favored-class.settings-integration-off", FavoredClassSettingsTests.DisabledIntegrationOffersNothing),
            Case("favored-class.settings-defaults-and-invalid", FavoredClassSettingsTests.DefaultsAndInvalidFilesUseTheCharterProfile),
            ...
            Case("favored-class.range-widening-success", FavoredClassPerformanceWideningTests.SuccessWidensRingAndRadiusTogether),
            Case("favored-class.range-widening-injected-failures", FavoredClassPerformanceWideningTests.InjectedFailuresRestoreRadiusAndRing),
            Case("favored-class.range-widening-ringless-deferred", FavoredClassPerformanceWideningTests.RinglessAndDeferredTargetsAreDistinguished),
            Case("favored-class.scope-nested-restores-previous", FavoredClassScopeStackTests.NestedScopesRestoreThePreviousFrame),
            Case("favored-class.scope-exception-closes", FavoredClassScopeStackTests.AnExceptionClosesTheScopeAndKeepsTheOuterFrame),
            Case("favored-class.scope-guard-closes-stale-frame", FavoredClassScopeStackTests.AGuardClosesAFrameItsCalleeLeftOpen),
            Case("favored-class.scope-retry-after-failure", FavoredClassScopeStackTests.ARetryAfterAFailureOpensAFreshScope),
            Case("favored-class.scope-finally-sources", FavoredClassScopeStackTests.ScopesCloseInFinallyBlocks),
            ...
            Case("favored-class.range-text-no-memory", FavoredClassRangePresentationTests.WithoutALiveAreaTheConfiguredRangeShows),
            ...
            Case("favored-class.range-group-end-throws", FavoredClassRangePresentationTests.AnEndThatThrowsKeepsTheAreaTracked),
            Case("favored-class.range-group-end-no-op", FavoredClassRangePresentationTests.AnEndThatDoesNothingKeepsTheAreaTracked),
            Case("favored-class.range-group-data-unavailable", FavoredClassRangePresentationTests.UnavailableDataKeepsTheAreaTracked),
            Case("favored-class.range-group-liveness-throws", FavoredClassRangePresentationTests.ALivenessReadThatThrowsForgetsNothing),
            Case("favored-class.range-group-no-untracked-widened", FavoredClassRangePresentationTests.NoUntrackedWidenedAreaBesideNativeText),
            ...
            Case("mostly-human.host-bridge-scope", ElementalMostlyHumanTests.HostBridgeIsExactlyScoped),
            Case("mostly-human.host-bridge-permission", ElementalMostlyHumanTests.HostBridgeAddsOnlyMostlyHumanGeniekin),
            Case("favored-class.aura-native-read-point", FavoredClassAdvancedTests.AuraIncrementFoldsIntoTheNativeMoraleModifier),
            Case("favored-class.pet-armor-current-pet", FavoredClassAdvancedTests.PetArmorFollowsTheCurrentQualifiedPetOnly),
            ...
            Case("favored-class.stored-plan-same-level-target", FavoredClassPowerTests.StoredPlanScopesItsSameLevelTarget),
            Case("favored-class.dependency-warning-classifies", FavoredClassDependencyWarningTests.MissingReferencesAreClassifiedByProof),
            Case("favored-class.dependency-warning-text", FavoredClassDependencyWarningTests.WarningTextIsPreciseAndSafe),
            Case("favored-class.dependency-warning-hooks", FavoredClassDependencyWarningTests.HooksOnlyObserve),
            ...
            Case("favored-class.icon-never-blank", FavoredClassIconTests.BlankIconsAreNeverPublished),
            Case("favored-class.icon-catalog-donors", FavoredClassIconTests.CatalogRecordsEveryDonor),
            Case("favored-class.revelation-manifest", FavoredClassRevelationTests.ManifestIsTheAuditedImplementableSet),
            Case("favored-class.revelation-leaves", FavoredClassRevelationTests.RevelationLeavesAreCommittedCounters),
            Case("favored-class.revelation-resource-formula", FavoredClassRevelationTests.ResourceMaximumMatchesTheNativeFormula),
            Case("favored-class.revelation-adapter-scope", FavoredClassRevelationTests.AdaptersAreScopedToTheChosenRevelation),
            Case("favored-class.performance-manifest", FavoredClassPerformanceTests.ManifestIsTheAuditedAreaSet),
            ...
            Case("outfit-audit.guarded-boundary", GunslingerOutfitAuditTests.GuardedBoundaryIsExact),
            Case("outfit-audit.deterministic-read-only", GunslingerOutfitAuditTests.InventoryIsDeterministicAndReadOnly),
            ...
            Case("elemental-heritages.catalog", ElementalHeritagePolicyTests.CatalogHasExactChoiceAndProviderInventory),
            ...
            Case("elemental-traits.summon-insight-boundaries", ElementalSummonInsightPolicyTests.RequiresTypedTemporaryFamilySpell),
            Case("elemental-traits.blood-healing-cap", ElementalBloodPolicyTests.ActualHealingAndNativeBoundariesAreExact),
            ...
            Case("elemental-traits.visible-save-matrix", ElementalVisibleTraitPersistenceTests.PublishedInventoryDistinguishesHistoricalAndWaivedPersistenceCoverage),
            ...
            Case("elemental-traits.breath-zero-dice", ElementalBreathPolicyTests.ConstructionDoesNotInventMinimumDamage),
            Case("elemental-traits.exact-ray-eligibility", ElementalCrystallineFormPolicyTests.ExactSemanticRayBoundaries),
            Case("elemental-traits.deflection-eligibility", ElementalCrystallineFormPolicyTests.DeflectionRequiresEveryNativeBoundary),
            Case("elemental-races.component-save-identities", ElementalComponentIdentityPolicyTests.PreservesLegacyStateAndRejectsAmbiguity),
            ...
            Case("elemental-traits.framework-identities", ElementalRaceProductionTests.TraitFrameworkManifestInventoryIsExact),
            Case("elemental-traits.blueprint-architecture", ElementalRaceProductionTests.TraitBlueprintArchitectureIsSlotAware),
            Case("elemental-heritages.architecture", ElementalRaceProductionTests.HeritageBlueprintArchitectureIsNarrow),
            Case("elemental-races.sla-affinity-hydraulic", ElementalRaceProductionTests.SlaAffinityAndHydraulicContractsAreNarrow),
            Case("elemental-affinity.ordinary-spells", ElementalSpellAffinityPolicyTests.OrdinarySpellsRequireMatchingDescriptor),
            Case("elemental-affinity.variants", ElementalSpellAffinityPolicyTests.VariantsAndParentsProduceAtMostOneBonus),
            Case("elemental-affinity.nonspell-sources", ElementalSpellAffinityPolicyTests.NonspellInvocationSourcesAreRejected),
            Case("elemental-affinity.boundary", ElementalSpellAffinityPolicyTests.InvocationBoundaryFailsClosed),
            Case("elemental-sla.parameters", ElementalRacialSpellLikePolicyTests.ParametersUseExactConfiguredLevels),
            Case("elemental-sla.dc", ElementalRacialSpellLikePolicyTests.DcUsesCurrentAbilityModifierExactly),
            Case("elemental-visual-rollback.atomic-conflict", ElementalVisualResourceRollbackPolicyTests.ForeignReplacementRefusesBeforeAnyRemoval),
            Case("elemental-visual-rollback.reverse-plan", ElementalVisualResourceRollbackPolicyTests.OwnedPlanIsReverseOrderedAndSkipsAbsentEntries),
            Case("elemental-visual-recovery.owned-classification", ElementalVisualResourceRecoveryPolicyTests.OwnedClassificationIsSeverityOrdered),
            ...
            Case("elemental-races.runtime-affinity", ElementalRaceProductionTests.RuntimeAffinityScenarioUsesNativeAbilityParams),
            Case("elemental-races.runtime-slas", ElementalRaceProductionTests.RuntimeSlaScenarioUsesNativeDelivery),
            Case("elemental-races.runtime-hydraulic-push", ElementalRaceProductionTests.RuntimeHydraulicPushScenarioUsesNativeManeuver),
            Case("elemental-races.runtime-native-identity", ElementalRaceProductionTests.RuntimeNativeIdentityScenarioUsesLiveEngineRules),
            Case("elemental-races.races-unleashed-compatibility", ElementalRaceProductionTests.RacesUnleashedCompatibilityIsExactAndSaveFree),
            ...
            Case("elemental-races.class-equipment", GunslingerOutfitRenderTests.ElementalClassEquipmentReusesProductionTransaction),
            Case("outfit-render.production-motion", GunslingerOutfitRenderTests.ProductionMotionIsGuardedAndExact),
            Case("elemental-races.motion", GunslingerOutfitRenderTests.ElementalRaceMotionReusesProductionTransaction),
            Case("outfit-render.production-persistence", GunslingerOutfitRenderTests.ProductionPersistenceIsGuardedAndExact),
            Case("elemental-races.persistence", GunslingerOutfitRenderTests.ElementalRacePersistenceIsGuardedAndExact),
            ...
            Case("brown-fur.publication-before-combined", BrownFurPublicationTransactionTests.InsertsBeforeCombinedArchetypeBlock),
            Case("brown-fur.publication-no-boundary", BrownFurPublicationTransactionTests.OrderedPublicationAppendsWithoutBoundary),
            Case("brown-fur.publication-ordered-rollback", BrownFurPublicationTransactionTests.OrderedRollbackPreservesLaterAppend),
            ...
            Case("brown-fur.cast-direct-delayed-process", BrownFurCastTests.DirectCastCoordinatorRetainsDelayedProcess),
            Case("brown-fur.cast-direct-four-sequential", BrownFurCastTests.DirectCastCoordinatorSupportsFourSequentialCasts),
            Case("brown-fur.cast-direct-revalidation-reuse", BrownFurCastTests.DirectCastRevalidatesAndReusesAbilitySafely),
            ...
            Case("summon-same-turn.outside-combat", SummonSameTurnActivationTests.OutsideCombatIsNative),
            Case("summon-same-turn.rtw-p", SummonSameTurnActivationTests.RealTimeWithPauseIsNative),
            Case("summon-same-turn.non-summon", SummonSameTurnActivationTests.NonSummonsAreNative),
            ...
            Case("teleportation.blueprint-identities", TeleportationBlueprintContractTests.StableIdentities),
            Case("teleportation.blueprint-local-isolation", TeleportationBlueprintContractTests.BlueprintPresentationAndModuleIsolation),
            Case("teleportation.publication-contract", TeleportationBlueprintContractTests.PublicationUsesExactListsAndDuplicateSafeMerge),
            ...
            Case("protection-alignment.terminal-and-succubus", ProtectionFromAlignmentControlImmunityTests.TerminalAndExpandedSuccubusRegistrationsBlock),
            Case("protection-alignment.descriptor-regression", ProtectionFromAlignmentControlImmunityTests.BroadDescriptorsAndUnrelatedEffectsRemainAllowed),
            ...
            Case("bodyguard-blueprints.identities", BodyguardBlueprintContractTests.ManifestIdentitiesAreExact),
            Case("bodyguard-blueprints.native-and-feats", BodyguardBlueprintContractTests.NativeAndFeatContractsAreExact),
            Case("bodyguard-blueprints.modes", BodyguardBlueprintContractTests.ModeContractsArePersistentAndIndependent),
            Case("bodyguard-publication.atomic-order", BodyguardBlueprintContractTests.PublicationIsAtomicAndDeterministic),
            Case("bodyguard-publication.partial-failure", BodyguardBlueprintContractTests.PartialFailureRestoresEverySurface),
            Case("bodyguard-publication.guid-conflict", BodyguardBlueprintContractTests.GuidConflictFailsBeforeMutation),
            Case("bodyguard-publication.runtime-adapter", BodyguardBlueprintContractTests.RuntimeAdapterTargetsExactSelections),
            Case("bodyguard-policy.eligibility", BodyguardPolicyTests.EligibilityRequiresEveryGate),
            Case("bodyguard-policy.adjacency", BodyguardPolicyTests.AdjacencyBoundariesAreEdgeAware),
            Case("bodyguard-policy.threat-and-aoo", BodyguardPolicyTests.ThreatAndNativeAooRemainAuthoritative),
            Case("bodyguard-policy.aid-roll", BodyguardPolicyTests.AidAnotherNaturalAndTotalRulesAreExact),
            Case("bodyguard-policy.resource-order", BodyguardPolicyTests.ResourceSpendPrecedesAndControlsAidRoll),
            Case("bodyguard-policy.aid-stacking", BodyguardPolicyTests.AidStackingAndOneAttemptAreExact),
            Case("bodyguard-policy.ac-attribution", BodyguardPolicyTests.ArmorClassAttributionIsTruthfulAndScoped),
            Case("bodyguard-policy.attack-selection", BodyguardPolicyTests.AttackSelectionIsPreRollAndStable),
            ...
            Case("immediate-economy.turn-aware", ImmediateActionEconomyPolicyTests.TurnBasedAvailabilityIsTurnAware),
            Case("immediate-economy.next-turn-debt", ImmediateActionEconomyPolicyTests.OffTurnDebtFollowsTheNextActualTurn),
            Case("immediate-economy.rejection-gates", ImmediateActionEconomyPolicyTests.DebtFlatFootedAndIncapacitationFailExactly),
            Case("immediate-economy.rtwp", ImmediateActionEconomyPolicyTests.RealTimeUsesTheNativeSixSecondBudget),
            Case("immediate-economy.completed-turn-swift", ImmediateActionEconomyPolicyTests.CompletedTurnSwiftDoesNotBlockLaterImmediate),
            ...
            Case("bodyguard-runtime.timing-and-ac", BodyguardRuntimeContractTests.AttackTimingAndAcScopeAreExact),
            Case("bodyguard-runtime.ac-breakdown", BodyguardRuntimeContractTests.ArmorClassBreakdownUsesNativeBodyguardSources),
            Case("bodyguard-runtime.delivery-seams", BodyguardRuntimeContractTests.DeliverySeamsRedirectCompleteRecipients),
            Case("bodyguard-runtime.harmony12-cleanup", BodyguardRuntimeContractTests.HarmonyTwelveCleanupContractsAreExplicit),
            Case("bodyguard-runtime.immediate-action-assembly", BodyguardRuntimeContractTests.ImmediateActionAssemblyContractIsExact),
            Case("bodyguard-runtime.guarded-scenarios", BodyguardRuntimeContractTests.GuardedRuntimeScenariosCoverTheSubsystem),
            Case("bodyguard-runtime.associated-riders", BodyguardRuntimeContractTests.AssociatedRidersUseTheFinalRecipient),
            Case("bodyguard-runtime.investigation", BodyguardRuntimeContractTests.InvestigationRecordsExactInstalledContracts),
            ...
            Case("aid-another.favored-contract", AidAnotherCompatibilityTests.FavoredClassSourceContractIsFailClosed),
            Case("aid-another.optional-lifecycle", AidAnotherCompatibilityTests.LifecycleAndStatusRemainOptional),
            Case("aid-another.guarded-runtime", AidAnotherCompatibilityTests.GuardedRuntimeContractIsExact),
            ...
            Case("eastern-weapons.border-sentinel-placement", EasternWeaponFoundationTests.BorderSentinelPlacementIsLaterAndSingular),
            ...
            Case("eastern-favored.nodachi-late-policy", EasternFavoredCompatibilityTests.NodachiValueAndLateMartialPolicyAreExact),
            Case("eastern-favored.martial-fact-shapes", EasternFavoredCompatibilityTests.LateMartialPolicyPreservesNativeFactShapes),
            Case("eastern-favored.load-dictionary-boundary", EasternFavoredCompatibilityTests.LoadDictionaryBoundaryIsLateAndTransactional),
            Case("eastern-favored.rollback-and-retry", EasternFavoredCompatibilityTests.LateCoordinatorRollbackAndRetryAreExact),
            Case("eastern-favored.foreign-contracts", EasternFavoredCompatibilityTests.FavoredAndTweakContractsAreExact),
            Case("eastern-favored.heirloom-blueprints", EasternFavoredCompatibilityTests.HeirloomNodachiIdentityAndMechanicsAreExact),
            Case("eastern-favored.heirloom-publication", EasternFavoredCompatibilityTests.HeirloomForeignPublicationIsAtomic),
            Case("eastern-favored.heirloom-partial-rollback", EasternFavoredCompatibilityTests.HeirloomPartialFailureRestoresEveryArray),
            Case("eastern-favored.runtime-profiles", EasternFavoredCompatibilityTests.RuntimeProfilesAndSettingsRestorationAreExact),
            Case("eastern-favored.module-gates", EasternFavoredCompatibilityTests.ModuleAndTraitDisabledGatesRemainIndependent),
            ...
            Case("presentation.player-text-policy", PlayerFacingPresentationAndDiscoverabilityTests.PlayerFacingTextPolicyRejectsLeaks),
            Case("acquisition.distributed-campaign", PlayerFacingPresentationAndDiscoverabilityTests.DistributedCampaignPassesDiscoverabilityPolicy),
            ...
            Case("presentation.source-tooltip-contracts", PlayerFacingPresentationAndDiscoverabilityTests.SourceTooltipsExcludeImplementationText),
            ...
            Case("fatigue.native-fresh", CanonicalFatiguePolicyTests.FreshOrdinaryFatigueAppliesFatigued),
            Case("fatigue.native-repeat", CanonicalFatiguePolicyTests.RepeatedOrdinaryFatigueRemainsFatigued),
            Case("fatigue.native-same-sequence", CanonicalFatiguePolicyTests.SameSequenceOrdinaryFatigueRemainsFatigued),
            Case("fatigue.native-no-downgrade", CanonicalFatiguePolicyTests.ExhaustedOrdinaryFatigueNeverDowngrades),
            Case("fatigue.native-exhaustion-fresh", CanonicalFatiguePolicyTests.FreshNativeExhaustionAppliesExhausted),
            Case("fatigue.native-exhaustion-replaces", CanonicalFatiguePolicyTests.FatiguedNativeExhaustionReplacesFatigue),
            Case("fatigue.native-exhaustion-idempotent", CanonicalFatiguePolicyTests.ExhaustedNativeExhaustionIsIdempotent),
            Case("fatigue.acadamae-fresh", CanonicalFatiguePolicyTests.FreshAcadamaeFatigueAppliesFatigued),
            Case("fatigue.acadamae-repeat", CanonicalFatiguePolicyTests.RepeatedAcadamaeFatigueEscalates),
            Case("fatigue.acadamae-exhausted", CanonicalFatiguePolicyTests.ExhaustedAcadamaeFatigueRemainsExhausted),
            ...
            Case("fatigue.cord-order", CanonicalFatiguePolicyTests.CordReceivesIntentSpecificIncomingCondition),
            Case("fatigue.intent-exact-key", CanonicalFatiguePolicyTests.IntentMatchesExactCollectionAndBlueprint),
            Case("fatigue.intent-one-shot", CanonicalFatiguePolicyTests.IntentIsOneShotAndDoesNotLeakLater),
            Case("fatigue.intent-nested", CanonicalFatiguePolicyTests.NestedUnrelatedIntentCannotClaimOuterRequest),
            Case("fatigue.intent-exception", CanonicalFatiguePolicyTests.ExceptionalIntentScopeCannotLeak),
            Case("fatigue.intent-thread", CanonicalFatiguePolicyTests.IntentIsThreadLocal),
            ...
            Case("midgame-firearms.designs-prices", MidgameFirearmTests.DesignsAndPricesFillTheMissingTier),
            Case("midgame-firearms.truthful-properties", MidgameFirearmTests.PropertyTextKeepsTheTradeoffs),
            ...
            Case("rapid-reload-gate.parent-official-catalog", RapidReloadPrerequisiteTests.ParentGateCoversExactlyTheOfficialCatalog),
            Case("rapid-reload-gate.parent-matches-official-children", RapidReloadPrerequisiteTests.ParentGateIsTheDisjunctionOfItsOfficialChildren),
            Case("rapid-reload-gate.parent-truth-table", RapidReloadPrerequisiteTests.ParentGateTruthTable),
            Case("rapid-reload-gate.children-firearm-exact", RapidReloadPrerequisiteTests.ChildGatesStayFirearmExact),
            Case("rapid-reload-evidence.complete-evidence-accepted", RapidReloadGateEvidenceTests.CompleteEvidenceIsAccepted),
            Case("rapid-reload-evidence.missing-observations-fail", RapidReloadGateEvidenceTests.MissingObservationsCannotScorePass),
            Case("rapid-reload-evidence.null-and-absent-rows-fail", RapidReloadGateEvidenceTests.NullObservationsCannotScorePass),
            Case("rapid-reload-evidence.unreserved-feat-slots-fail", RapidReloadGateEvidenceTests.UnreservedOrFilledFeatSlotsCannotScorePass),
            Case("rapid-reload-evidence.scoring-validates-fixture-proficiency", RapidReloadGateEvidenceTests.FixtureProficiencyIsValidatedByTheScoringEvaluators),
            Case("rapid-reload-evidence.confirmation-requires-native-completeness", RapidReloadGateEvidenceTests.ConfirmationRequiresNativeCompleteness),
            Case("rapid-reload-evidence.cancelled-visits-are-not-a-class-change", RapidReloadGateEvidenceTests.CancelledVisitsCannotStandInForAPendingClassChange),
            Case("rapid-reload-evidence.repaired-completion-fails", RapidReloadGateEvidenceTests.RepairedOrUngatedCompletionCannotScorePass),
            Case("rapid-reload-evidence.hand-granted-musket-master-fails", RapidReloadGateEvidenceTests.ManuallyGrantedMusketMasterCannotScorePass),
            ...
            Case("broken-sequence.construction-repair-does-not-revive", BrokenSequenceInterruptionTests.ConstructionRepairDoesNotReviveCancelledOrder),
            Case("broken-sequence.full-attack-ends-after-break", BrokenSequenceInterruptionTests.FullAttackEndsAfterCommittedBreak),
            Case("broken-sequence.resume-blocked-by-later-degradation", BrokenSequenceInterruptionTests.ResumeBlockedByLaterDegradation),
            Case("broken-sequence.wiring-misfire-records-degradation", BrokenSequenceInterruptionTests.WiringMisfireRuntimeRecordsCommittedDegradation),
            Case("broken-sequence.wiring-all-commit-paths-notify", BrokenSequenceInterruptionTests.WiringAllCommitPathsNotifyInterruption),
            Case("broken-sequence.wiring-full-attack-gate-first", BrokenSequenceInterruptionTests.WiringFullAttackEndsBeforeNextShot),
            Case("broken-sequence.wiring-construction-and-click-context", BrokenSequenceInterruptionTests.WiringConstructionGateAndPlayerClickContext),
            Case("broken-sequence.wiring-suppression-transient", BrokenSequenceInterruptionTests.WiringSuppressionStateStaysTransient),
            Case("rest-maintenance.genuine-completion-qualifies", CompletedRestMaintenanceTests.GenuineCompletionQualifies),
            Case("rest-maintenance.non-completion-never-qualifies", CompletedRestMaintenanceTests.NonCompletionNeverQualifies),
            Case("rest-maintenance.missing-prerequisites-no-repair", CompletedRestMaintenanceTests.MissingPrerequisitesDoNotRepair),
            Case("rest-maintenance.item-decisions-actual-condition", CompletedRestMaintenanceTests.ItemDecisionsFollowActualCondition),
            Case("rest-maintenance.blocked-report-requires-damage", CompletedRestMaintenanceTests.BlockedReportRequiresDamage),
            Case("rest-maintenance.summaries-honest", CompletedRestMaintenanceTests.SummariesAreHonest),
            ...
            Case("field-repair.capability-start-and-delivery", FieldRepairRestrictionTests.CapabilityEnforcedAtStartAndDelivery),
            ...
            Case("gun-training.empty-pick-completes", GunslingerDeedFixTests.GunTrainingEmptyPickCompletesTheLevel),
            ...
            Case("dead-shot.threat-rule", GunslingerDeedFixTests.DeadShotThreatRule),
            ...
            Case("firearm-support.exact-public-boundary",
                FirearmFeatIconTests.OfficialSupportBoundaryIsExact),
            Case("firearm-feat-icons.semantic-publication", FirearmFeatIconTests.NativeStylePublicationIsExact),
            Case("firearm-feat-icons.native-monogram-scope", FirearmFeatIconTests.NativeMonogramScopeIsExact),
            Case("scroll-item-icons.composed-assignment", ScrollItemIconTests.ComposedScrollAssignmentIsExact),
            Case("scroll-item-icons.registered-assets", ScrollItemIconTests.ComposedScrollAssetsAreRegistered),
            Case("scroll-item-icons.catalog-contract", ScrollItemIconTests.CatalogAndRuntimeContractStayAligned),
            Case("scroll-item-icons.reference-dump-readonly", ScrollItemIconTests.NativeScrollReferenceDumpStaysReadonly),
            Case("icon-graph.deep-actions", IconGraphSnapshotTests.DeepActionsAreObservedWithoutRecursion),
            Case("icon-graph.cycles-and-shared-nodes", IconGraphSnapshotTests.CyclesAndSharedNodesRetainTheirEdges),
            Case("icon-graph.foreign-boundary", IconGraphSnapshotTests.ForeignBlueprintGraphsAreNeverTraversed),
            Case("icon-graph.node-budget", IconGraphSnapshotTests.NodeBudgetFailsWithAnExactPath),
            Case("icon-census.exact-control-request", IconGraphSnapshotTests.ControlRequiresExactNoSaveRequest),
            Case("icon-graph.changed-targets", IconGraphSnapshotTests.ReferenceAndTopologyChangesInvalidateSnapshot),
            Case("firearm-feat-icons.runtime-visual-evidence", FirearmFeatIconTests.RuntimeVisualEvidenceIsGuardedAndLive),
            Case("native-racial-actions.exact-39-set", NativeRacialActionIconFixtureTests.ExactConsumerSetIsFixed),
            Case("native-racial-actions.race-set-corruption", NativeRacialActionIconFixtureTests.RaceSetCorruptionIsRejected),
            Case("native-racial-actions.modifier-cache-ownership", NativeRacialActionIconFixtureTests.ModifierCacheOwnershipIsExact),
            Case("native-racial-actions.row-classification", NativeRacialActionIconFixtureTests.RowClassificationIsDerived),
            Case("native-racial-actions.request-case-gating", NativeRacialActionIconFixtureTests.RequestCaseIsNarrowlyAllowlisted),
            Case("native-racial-actions.fixture-dispatch", NativeRacialActionIconFixtureTests.FixtureDispatchAndRestorationAreWired),
            Case("native-racial-actions.control-evidence-evaluation", NativeRacialActionIconFixtureTests.ActionEvidenceEvaluationRequiresRenderedControl),
            Case("native-racial-actions.modifier-cache-cleanup-dispatch", NativeRacialActionIconFixtureTests.ModifierCacheCleanupDispatchIsExact),
            Case("native-racial-actions.existing-cache-preservation", NativeRacialActionIconFixtureTests.ExistingCachePreservationIsExact),
            ...
            Case("favored-class.permission-graph-seam-test-only", HarnessEvidenceTests.PermissionGraphSeamIsTestOnly),
            ...
            Case("unified-repair.vendor-stock-cleanup", UnifiedFirearmRepairTests.UnifiedVendorStockCleanupContract),
            Case("retired-vendor-stock.table-absence-zero-rows", RetiredVendorStockPolicyTests.TableAbsenceAcceptsZeroRows),
            Case("retired-vendor-stock.table-absence-one-row-rejected", RetiredVendorStockPolicyTests.TableAbsenceRejectsOneLeftoverRow),
            Case("retired-vendor-stock.table-absence-many-rows-rejected", RetiredVendorStockPolicyTests.TableAbsenceRejectsManyLeftoverRows),
            Case("retired-vendor-stock.table-absence-negative-rejected", RetiredVendorStockPolicyTests.TableAbsenceRejectsNegativeRows),
            Case("retired-vendor-stock.sweep-single-retired-item", RetiredVendorStockPolicyTests.SweepSelectsSingleRetiredItem),
            Case("retired-vendor-stock.sweep-many-retired-items", RetiredVendorStockPolicyTests.SweepSelectsManyRetiredItemsOfBothIdentities),
            Case("retired-vendor-stock.sweep-never-selects-unrelated", RetiredVendorStockPolicyTests.SweepNeverSelectsUnrelatedOrToolStock),
            Case("retired-vendor-stock.sweep-protects-player-inventory", RetiredVendorStockPolicyTests.SweepProtectsPlayerInventoryEvenWithRetiredKits),
            Case("retired-vendor-stock.sweep-clean-stock-selects-nothing", RetiredVendorStockPolicyTests.SweepOnCleanStockSelectsNothing),
            Case("retired-vendor-stock.sweep-null-inputs-rejected", RetiredVendorStockPolicyTests.SweepRejectsNullInputs),
            Case("retired-vendor-stock.sweep-description", RetiredVendorStockPolicyTests.SweepDescriptionNamesVendorAndCounts),
