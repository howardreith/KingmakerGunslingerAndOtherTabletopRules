...
namespace KingmakerGunslinger.DomainTests
{
    internal static partial class Program
    {
        private static readonly TestCase[] Cases =
        {
            ...
            Case("feature-settings.matrix-counts", FeatureModuleSettingsTests.NineModuleMatrixCountsAreExact),
            Case("feature-modules.publication-plans", FeatureModuleSettingsTests.PublicationPlansAreIndependent),
            Case("feature-modules.runtime-matrix", FeatureModuleSettingsTests.RuntimeMatrixUsesAuthoritativeNineModuleCatalog),
