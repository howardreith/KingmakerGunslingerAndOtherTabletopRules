...
namespace KingmakerGunslinger.DomainTests
{
    internal static partial class Program
    {
        private static readonly TestCase[] Cases =
        {
            ...
            Case("feature-settings.one-thousand-twenty-four-combinations", FeatureModuleSettingsTests.OneThousandTwentyFourCombinationsRoundTrip),
            ...
            Case("feature-settings.matrix-counts", FeatureModuleSettingsTests.TenModuleMatrixCountsAreExact),
            Case("feature-modules.publication-plans", FeatureModuleSettingsTests.PublicationPlansAreIndependent),
            Case("feature-modules.runtime-matrix", FeatureModuleSettingsTests.RuntimeMatrixUsesAuthoritativeTenModuleCatalog),
