...
namespace KingmakerGunslinger.DomainTests
{
    internal static partial class Program
    {
        private static readonly TestCase[] Cases =
        {
            ...
            Case("feature-settings.two-hundred-fifty-six-combinations", FeatureModuleSettingsTests.TwoHundredFiftySixCombinationsRoundTrip),
            ...
            Case("feature-settings.matrix-counts", FeatureModuleSettingsTests.EightModuleMatrixCountsAreExact),
