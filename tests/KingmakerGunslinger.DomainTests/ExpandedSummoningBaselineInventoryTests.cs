...
{
    /// <summary>
    /// Sprint 0 of the Expanded Summoning charter freezes the shipped surface.
    /// These tests pin the observed baseline and prove the observer is inert.
    /// </summary>
    internal static class ExpandedSummoningBaselineInventoryTests
    {
        internal static void ShippedSurfaceMatchesFrozenBaseline()
        {
            Assertions.Equal(67, ExpandedSummoningBaselineInventory.UniqueCreatures,
                "Baseline unique creature count changed.");
            Assertions.Equal(66, ExpandedSummoningBaselineInventory.RosterEntries(
                SummonFamily.Monster), "Baseline SM roster count changed.");
            Assertions.Equal(57, ExpandedSummoningBaselineInventory.RosterEntries(
                SummonFamily.NaturesAlly), "Baseline SNA roster count changed.");
            Assertions.Equal(361, ExpandedSummoningBaselineInventory
                .RegisteredPlacements(SummonFamily.Monster),
                "Baseline SM registered placements changed.");
            Assertions.Equal(320, ExpandedSummoningBaselineInventory
                .RegisteredPlacements(SummonFamily.NaturesAlly),
                "Baseline SNA registered placements changed.");
            Assertions.Equal(371, ExpandedSummoningBaselineInventory
                .VisibleChoices(SummonFamily.Monster),
                "Baseline SM visible choice count changed.");
            Assertions.Equal(322, ExpandedSummoningBaselineInventory
                .VisibleChoices(SummonFamily.NaturesAlly),
                "Baseline SNA visible choice count changed.");
        }

        /// <summary>
        /// The 693 headline figure must decompose exactly, so a later sprint
        /// cannot quietly move a choice between the generated and native pools.
        /// </summary>
        internal static void VisibleChoicesDecomposeExactly()
        {
            ...
            Assertions.Equal(667, generated, "Published generated placements changed.");
            Assertions.Equal(26, wrappers, "Native wrapper count changed.");
            Assertions.Equal(693, generated + wrappers,
        ...
        internal static void ObserverIsInertAndDeterministic()
        {
            ...
            Assertions.True(first.Contains("\"totalVisibleChoices\": 693"),
