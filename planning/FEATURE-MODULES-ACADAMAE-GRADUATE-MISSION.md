...
Base: `origin/master` at `7a99ce5ac6d6976212310f997bd39ddfe4a57935` (0.0.74, `0.0.74-paper-cartridges-auto-reload`). Required branch: `codex/feature-modules-acadamae-graduate`.

The identity layer always registers every stable project blueprint. Settings gate only new public selection and acquisition. Settings are immutable for a process, missing/legacy/malformed settings fail open to ON/ON, and UI changes require a full restart. Existing identities and mechanics remain functional when publication is disabled.
