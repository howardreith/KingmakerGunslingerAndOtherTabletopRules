...
| Scatter weapons | firearm rules; ADR-0037 | SOURCE-IMPLEMENTED | special-range definition, exact-reference target planner, independent volley aggregation, one-discharge boundary, triple-explosion policy | 33 focused scatter cases within 657-test suite | exact `0.0.32` mod-load PASS on `31678e2`; feature runtime absent | Resolve numeric cone distance, implement native delivery, enable content, and runtime qualify | Pending |
