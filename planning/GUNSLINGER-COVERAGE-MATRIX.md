...
| Generic definition-driven Reload/Repair/Overhaul | Sprint 30 contract | SOURCE-QUALIFIED | `Actions/` plus compatibility adapters | 611-test reported suite | no Sprint 30 in-game acceptance yet | Guarded 0.0.30 runtime qualification | Pending |
