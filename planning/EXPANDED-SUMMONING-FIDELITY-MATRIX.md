...
| Leopard | SM III; SNA III | `f36aad1d463444c69950f219457b894f`; `768275c9885dd954fb3c84ba69ac4281` | Medium animal 3; 16/19/15/2/13/6; speed 30; NA +1; bite 1d6, two claws plus native extra rake limbs; Pounce, Weapon Finesse; claw grab on the shared summon grapple lifecycle; charge-only rake gate (Sprint 7) | Native four-claw body is Owlcat's rake adaptation; grab omitted because the only proven generic graph includes unrelated constrict state | Structural/runtime/visual/persistence/profile PASS; representative pounce combat PASS |
...
| Tiger (Phase 1 Sprint 8) | SNA IV | `KMG.Summoning.Unit.Tiger`; leopard rig `768275c9885dd954fb3c84ba69ac4281` at a 1.25 view scale | Large animal 6; 23/15/17/2/12/6; speed 40; NA +3; native 2d6 bite; four project 1d8 claws (two rake); Pounce; Improved Initiative, Skill Focus (Perception), Weapon Focus (claw); claw grab on the shared summon grapple lifecycle; charge-only rake; procedural striped coat generated in the rig's texture space | Run and Skill Focus (Stealth) omitted; the rake rider is a silent automatic miss outside a charge or a hold; no native tiger exists | Phase 1 state file records the guarded evidence |
...
| Lion | SM IV; SNA IV | `14c7cbb0f32f4e30bbefaeaccba10269`; Leopard view `768275c9885dd954fb3c84ba69ac4281` | Large animal 5; 21/17/15/2/12/6; speed 40; NA +3; bite 1d8, two claws plus native extra rake limbs; Pounce; claw grab on the shared summon grapple lifecycle; charge-only rake gate; tawny visual tint on the leopard rig (Sprint 7) | Native four-claw body is Owlcat's rake adaptation; grab and Run omitted | Structural/runtime/visual/persistence/profile PASS; representative pounce combat PASS |
...
| Pony (Phase 1 Sprint 3) | SM I; SNA I | KMG unit per `blueprints/blueprints.json` (`KMG.Summoning.Unit.Pony`); native summoned pony `3f95557fc806db741b500a5735990841` | Medium animal 2; 13/13/14/2/11/4; speed 40; NA +0; two 1d3 hooves as primary limbs | Endurance and Run omitted; docile secondary-hoof cadence not represented | Phase 1 state file records the guarded evidence |
| Horse (Phase 1 Sprint 3) | SM II; SNA II | `KMG.Summoning.Unit.Horse`; native summoned horse `5bb9579fdb2b26b48bb10d61c81cfdfb` | Large animal 2; 16/14/17/2/13/7; speed 50; NA +0; two 1d4 hooves as primary limbs; reduced reach | Endurance and Run omitted | Phase 1 state file records the guarded evidence |
...
| Cyclops (Phase 1 Sprint 3) | SNA V | `KMG.Summoning.Unit.Cyclops`; body donor `124f1c45ef24d654e9cd420fe84f7f36` | Large humanoid 10; 21/8/15/10/13/8; speed 30; NA +7; native greataxe (Large 3d6); Ferocity, Power Attack, Cleave; Flash of Insight bounded to one swift-action automatic hit and critical threat per summoning | Hide armor, heavy crossbow, Alertness, Great Cleave, Improved Bull Rush omitted; confirmation roll ordinary | Phase 1 state file records the guarded evidence |
...
| Creature | Families/tier | KMG unit; visual donor | Delivered chassis/offense | Conservative deviation | Qualification |
|---|---|---|---|---|---|
| Dire Lion | SM V; SNA V | `56c64aa6765a4c37a1b30c0c5b31427b`; Smilodon `beae4985629a6f64eb98081e3171e4c1` | Large animal 8; 25/15/17/2/12/10; speed 40; NA +4; bite 1d8, two 1d6 claws plus two secondary rake claws; Pounce, Improved Initiative, Perception/claw focus; claw grab on the shared summon grapple lifecycle; charge-only rake gate (Sprint 7) | Grab and Run omitted; secondary rake follows Owlcat's native pounce adaptation | Structural/runtime/visual/persistence/profile PASS; representative pounce combat PASS |
...
| Smilodon | SM VI; SNA VI | `d15ee151c2274f9f86ab523f111bc3af`; `beae4985629a6f64eb98081e3171e4c1` | Large animal 14; 27/15/17/2/12/10; speed 40; NA +6; 2d6/19-20 bite, two 2d4 claws plus two secondary rake claws; Pounce and exact critical/focus feats; claw grab on the shared summon grapple lifecycle; charge-only rake gate (Sprint 7) | Grab and Run omitted; secondary rake follows Owlcat's native pounce adaptation | Structural/runtime/visual/persistence/profile PASS; representative pounce combat PASS |
