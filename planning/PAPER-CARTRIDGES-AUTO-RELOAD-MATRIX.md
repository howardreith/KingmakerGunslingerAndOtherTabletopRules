...
| `BlueprintBootstrap` / manifests / project files | Baseline 242 registrations and 243 stable ledger rows | Item, two tokens, activatable, marker, and crafting ability appended: 248 active / 249 total including one reserved |
