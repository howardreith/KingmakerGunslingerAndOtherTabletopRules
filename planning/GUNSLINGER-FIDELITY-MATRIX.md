...
| 1 | Grit: Wisdom-based pool, daily reset, critical/killing-blow recovery | EXACT | Runtime-qualified stable per-unit resource initializes to the Wisdom-floor maximum, spends atomically, does not refill on level-up, restores capped, and refills through native daily rest | Qualify save-load and multiclass/respec persistence, then firearm event dedupe |
