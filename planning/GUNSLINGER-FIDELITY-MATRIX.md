...
| 1 | Quick Clear | ADAPTED | Source-qualified exact single-equipped-firearm actions: standard action requires positive grit without spending; move action spends one grit; both atomically change the item-owned misfire-origin Broken state to Normal without a repair kit | Require exact-commit mod load and two guarded detached runtime PASS runs |
