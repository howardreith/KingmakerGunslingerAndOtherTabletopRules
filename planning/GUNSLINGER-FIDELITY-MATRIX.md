...
| 1 | Grit: Wisdom-based pool, daily reset, critical/killing-blow recovery | EXACT | Pool/rest/persistence are runtime-qualified. Source-qualified recovery binds confirmed critical and exact weapon-damage zero crossing separately, excludes helpless/unaware/below-half-level targets, and weakly deduplicates attack/target references | Exact mod load and two detached recovery PASS runs |
