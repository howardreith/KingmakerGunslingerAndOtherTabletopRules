...
| 2/6/10/14/18 | Nimble +1..+5 | EXACT | Source-qualified five cumulative native Dodge-descriptor facts at exact levels; equipment subscriber applies each +1 only in light/no armor and native flat-footed AC excludes them | Require exact-commit mod load and two guarded detached runtime PASS runs |
