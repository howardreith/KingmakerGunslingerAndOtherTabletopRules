...
| 3 | Gunslinger Initiative | ADAPTED | Runtime-qualified +2 slice: level-three feature adds +2 to the owning unit's exact native initiative roll while current grit is positive, with no spend and rule-object duplicate protection | Resolve the Quick Draw/free-hands/visible-firearm clause from exact weapon-set contracts before marking the full feature complete |
