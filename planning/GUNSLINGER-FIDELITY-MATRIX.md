...
| 1 | Grit: Wisdom-based pool, daily reset, critical/killing-blow recovery | EXACT | Source-qualified bounded pool implements Wisdom modifier minimum 1, explicit maximum bonuses, daily reset, atomic spend/restore, clamping, and per-unit operation dedupe; Kingmaker persistence/rest and firearm recovery remain pending | Bind persistent per-unit resource with qualifying firearm event dedupe |
